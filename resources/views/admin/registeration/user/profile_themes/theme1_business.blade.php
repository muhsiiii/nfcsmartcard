...
<body style="background: #F8F9FA;">
		<div class="container-main mt-4">
			<div class="green-bg primary-bg" style="background-image: url({{ asset('nfc/images/1457718455276\ 1.png') }});background-repeat: no-repeat;background-size: 100% auto;background-position: center;background-repeat: no-repeat;background-size: cover;height: -webkit-fill-available;">
			</div>
			<div class="details">
				<div class="row">
					<div class="col-lg-12">
						<div class="bussines-profile-dv">
							<h4 class="business-text">Business profile</h4>
						<div class="row">
							<div class="col-lg-5">
								<div class="business-card">
									<div class="card-deatails">
										<div class="profile-img-dv">
											<img class="profile-img" src="{{ asset('upload/'.$profilePreview->logo) }}" alt="">
										</div>
										<div class="business-content">
											<h3 class="business-name">{{ $profilePreview->business_name }}</h3>
											<h6 class="email mb-0">{{ $profilePreview->industry }}</h6>
											<h6 class="number mb-0">{{ $profilePreview->phone }}</h6>
											<h6 class="date mb-0" style="display: flex;"><i style="margin-right: 5px;" class="ri-global-line"></i>{{ $profilePreview->website }}</h6>
										</div>
									</div>
									<div class="bs-social-icons-main">
								...
								<div class="bio-add-bsnss">
									<div class="bio-dv primary-bg h-p" style="background-image: url({{ asset('nfc/images/circle.png') }});background-repeat: no-repeat;background-size: 100% auto;background-position: center;background-repeat: no-repeat;background-size: cover;height: -webkit-fill-available;">
										<div class="heading-bio">
											...
											<h3 class="bio-head-text text-white mb-0">DESCRIPTION</h3>
										</div>
										<p class="text-white sub-text-bio mb-0">{!! $profilePreview->description !!}</p>
									</div>
