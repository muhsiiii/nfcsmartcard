                        ...
                        <form>
                            <div id="form1">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="uname" class="form-control"
                                            placeholder="Enter Your Name" value="{{ $profiles->user_name }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="email" id="uemail" class="form-control"
                                            placeholder="Enter Your Email" value="{{ $profiles->email }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="tel" id="uphone" class="form-control"
                                            placeholder="Enter Your Phone Number" value="{{ $profiles->phone }}">
                                        <span class="uphoneerror" style="color:red;font-size:16px"></span>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="name" class="col-sm-3 col-form-label text-right">Date of
                                        Birth:</label>
                                    <div class="col-sm-6">
                                        <input type="date" id="udob" class="form-control"
                                            placeholder="Enter Your DOB" value="{{ $profiles->dob }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea id="uaddress" class="form-control">{{ $profiles->address }}</textarea>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea id="uBio" class="ckeditor form-control">{{ $profiles->bio }}</textarea>
                                    </div>
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="url" id="uinstagram" class="form-control"
                                            placeholder="Instagram Profile" value="{{ $profiles->instagram }}"><br>
                                        <input type="url" id="utwitter" class="form-control"
                                            placeholder="Twitter Profile" value="{{ $profiles->twitter }}"><br>
                                        <input type="url" id="ulinkedin" class="form-control"
                                            placeholder="LinkedIn Profile" value="{{ $profiles->linkedin }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="fullname" class="form-control"
                                            placeholder="Full Name" value="{{ $profiles->emergency_name }}"><br>
                                        <span class="fullnameerror" style="color:red;font-size:16px"></span>
                                        <input type="text" id="relationship" class="form-control"
                                            placeholder="Relationship to User"
                                            value="{{ $profiles->relation_user }}"><br>
                                        <span class="relationshiperror" style="color:red;font-size:16px"></span>
                                        <input type="tel" id="contact" class="form-control"
                                            placeholder="Contact Information" value="{{ $profiles->contact_info }}">
                                        <span class="contacterror" style="color:red;font-size:16px"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6" id="conditionhtml">
                                        <select class="form-control" style="width: 100%;" id="dropdown">
                                            @foreach ($dropdownDatas as $dropdownData)
                                                <option value="{{ $dropdownData->condition }}"
                                                    @if ($dropdownData->condition == $profiles->conditions) selected @endif>
                                                    {{ $dropdownData->condition }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <button onclick="addNewItem(event)" class="btn btn-primary mt-1">Add</button> --}}
                                        ...
                                        <span class="conditionerror" style="color:red;font-size:16px"></span>
                                    </div>
                                </div>
                                ...
                                <div class="modal fade" id="modal-condition">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <form>
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="bannerHeading">Chronic medical conditions
                                                    </h4>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <input class="form-control"
                                                                    placeholder="enter new condition" id="newcondition"
                                                                    type="text">
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <input class="btn btn-primary offset-sm-2" type="button"
                                                        value="Save" onclick="conditionModalSave()">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                        ...
                                        <select class="form-control" style="width: 100%;" id="allergy">
                                            @foreach ($dropdownallergyDatas as $dropdownallergyData)
                                                <option value="{{ $dropdownallergyData->allergy }}"
                                                    @if ($dropdownallergyData->allergy == $profiles->allergies) selected @endif>
                                    ...
                                    <button onclick="addNewAllergy(event)" class="btn btn-primary mt-1">Add</button> --}}
                                        ...
                                        <span class="allergyerror" style="color:red;font-size:16px"></span>
                                    </div>
                                </div>
                                        ...
                                        <div class="modal-content">
                                            <form>
                                                ...
                                                <div class="modal-body">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <input class="form-control"
                                                                    placeholder="enter new allergy" id="newallergy"
                                                                    type="text">
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <input type="hidden" id="userid">
                                                    <input class="btn btn-primary offset-sm-2" type="button"
                                                        value="Save" onclick="allergyModalSave()">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" style="width: 100%;" id="blood">
                                            <option value="{{ $profiles->blood }}" selected>{{ $profiles->blood }}
                                            </option>
                                        ...
                                        <span class="blooderror" style="color:red;font-size:16px"></span>
                                    </div>
                                </div>

                                <div class="card-footer">
                                    <a class="btn btn-default offset-sm-3" href="{{ route('userprofile',$user_id) }}">Back</a>&emsp;
                                    <button type="button" id="addBtn" class="btn btn-primary"
                                        onclick="userUpdate('{{ $profiles->id }}')">
                                        Save
                                    </button>
                                </div>
                    ...
                    @else
                        <form>
                            <div id="business_form">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-sm-3 col-form-label text-right">Business
                                        Name:</label>
                                    <div class="col-sm-6">
                                        <input type="text" id="bbusinessName" class="form-control"
                                            placeholder="Enter Business Name" value="{{ $profiles->business_name }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 col-10">
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input class="custom-file-input" id="blogo" type="file"  onchange="logoImage()">
                                                <label class="custom-file-label" for="image4">Choose file</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="modalLabel">How to crop image before upload
                                                    image
                                                    in laravel 9 - Techsolutionstuff</h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">×</span>
                                                </button>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary"
                                                    id="logocrop">Crop</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <input type="hidden" name="logo_name" id="logo_name" value="{{ $profiles->logo }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" style="width: 100%;" id="bindustry">
                                            @foreach ($dropdownindustryDatas as $dropdownindustryData)
                                                <option value="{{ $dropdownindustryData->industry }}">
                                                    {{ $dropdownindustryData->industry }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div class="modal-content">
                                            <form>
                                                ...
                                                <div class="modal-body">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <input class="form-control"
                                                                    placeholder="enter new industry" id="industry"
                                                                    type="text">
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <input type="hidden" id="userid">
                                                    <input class="btn btn-primary offset-sm-2" type="button"
                                                        value="Save" onclick="IndustrySave()">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label for="disclaimer" class="col-sm-3 col-form-label text-right">Address :</label>
                                    <div class="col-sm-6">
                                        <textarea id="baddress" class="form-control">{{ $profiles->address }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="url" id="bwebsite" class="form-control"
                                            placeholder="Enter Your Website Url" value="{{ $profiles->website }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea id="bdescription" class="ckeditor form-control">{{ $profiles->description }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="url" id="blinkedin" class="form-control"
                                            placeholder="LinkedIn Profile" value="{{ $profiles->linkedin }}"><br>
                                    </div>
                                </div>
                                ...
                                <div class="card-footer">
                                    <a class="btn btn-default offset-sm-3" href="{{ route('userprofile',$user_id) }}">Back</a>&emsp;
                                    <button type="button" id="addBtn" class="btn btn-primary"
                                        onclick="businessUpdate('{{ $profiles->id }}')">
                                        Save </button>
                                </div>
                            </div>
                        </form>
...
<script>
    ...
    function userUpdate(pid) {
        ...
        var dob = $('#udob').val();
        var address = $('textarea#uaddress').val();
        ...
        var bloodtype = $('select#blood').val();
        ...
        if (!email) {
            ...
            $('.uemailerror').show().css('color', 'red');
            $('.uemailerror').text("enter email*");
            return false;
        } else {
        ...
        if (!phone) {
            ...
            $('.uphoneerror').show().css('color', 'red');
            $('.uphoneerror').text("choose date*");
            return false;
        } else {
        ...
        if (!address) {
            $('#uaddress').focus();
            $('#uaddress').css('border', '1px solid red');
            $('.uaddresserror').show().css('color', 'red');
            $('.uaddresserror').text("choose date*");
            return false;
        } else {
            $('#uaddress').css('border', '1px solid #CCC');
            $('.uaddresserror').hide();
        }
        ...
        if (!Bio) {
            $('#uBio').focus();
            $('#uBio').css('border', '1px solid red');
            $('.uBioerror').show().css('color', 'red');
            $('.uBioerror').text("choose date*");
            return false;
        } else {
            $('#uBio').css('border', '1px solid #CCC');
            $('.uBioerror').hide();
        }
        ...
        if (!fullname) {
            ...
            $('.fullnameerror').show().css('color', 'red');
            $('.fullnameerror').text("choose date*");
            return false;
        } else {
        ...
        if (!relationship) {
            ...
            $('.relationshiperror').show().css('color', 'red');
            $('.relationshiperror').text("choose date*");
            return false;
        } else {
            $('#relationship').css('border', '1px solid #CCC');
        ...
        if (!contact) {
            ...
            $('.contacterror').show().css('color', 'red');
            $('.contacterror').text("choose date*");
            return false;
        } else {
        ...
        if (!condition) {
            ...
            $('.conditionerror').show().css('color', 'red');
            $('.conditionerror').text("choose date*");
            return false;
        } else {
        ...
        if (!allergy) {
            $('#allergy').focus();
            $('#allergy').css('border', '1px solid red');
            $('.allergyerror').show().css('color', 'red');
            $('.allergyerror').text("choose date*");
            return false;
        } else {
            $('#allergy').css('border', '1px solid #CCC');
            $('.allergyerror').hide();
        }
        ...
        if (!bloodtype) {
            ...
            $('.blooderror').show().css('color', 'red');
            $('.blooderror').text("choose date*");
            return false;
        } else {
            $('#blood').css('border', '1px solid #CCC');
            $('.blooderror').hide();
        }
    ...
    function businessUpdate(pid) {

        var businessname = $('#bbusinessName').val();
        var theme = $('select#business_theme').val();

        var logo = $('#logo_name').val();
        var industry = $('select#bindustry').val();
        var address = $('textarea#baddress').val();
        ...
        if (!businessname) {
            $('#bbusinessName').focus();
            $('#bbusinessName').css('border', '1px solid red');
            $('.bbusinessNameerror').show().css('color', 'red');
            $('.bbusinessNameerror').text("enter name*");
            return false;
        } else {
            $('#bbusinessName').css('border', '1px solid #CCC');
            $('.bbusinessNameerror').hide();
        }


        if (!industry) {
            $('#bindustry').focus();
            $('#bindustry').css('border', '1px solid red');
            $('.bindustryerror').show().css('color', 'red');
            $('.bindustryerror').text("enter email*");
            return false;
        } else {
            $('#bindustry').css('border', '1px solid #CCC');
            $('.bindustryerror').hide();
        }
        ...
        if (!address) {
            ...
            $('.baddresserror').show().css('color', 'red');
            $('.baddresserror').text("enter email*");
            return false;
        } else {
            $('#baddress').css('border', '1px solid #CCC');
            $('.baddresserror').hide();
        }
        ...
        if (!phone) {
            ...
            $('.bphoneerror').show().css('color', 'red');
            $('.bphoneerror').text("enter email*");
            return false;
        } else {
            $('#bphone').css('border', '1px solid #CCC');
            $('.bphoneerror').hide();
        }
        ...
        if (!website) {
            $('#bwebsite').focus();
            $('#bwebsite').css('border', '1px solid red');
            $('.bwebsiteerror').show().css('color', 'red');
            $('.bwebsiteerror').text("enter email*");
            return false;
        } else {
            $('#bwebsite').css('border', '1px solid #CCC');
            $('.bwebsiteerror').hide();
        }
        ...
        if (!description) {
            $('#bdescription').focus();
            $('#bdescription').css('border', '1px solid red');
            $('.bdescriptionerror').show().css('color', 'red');
            $('.bdescriptionerror').text("enter email*");
            return false;
        } else {
            $('#bdescription').css('border', '1px solid #CCC');
            $('.bdescriptionerror').hide();
        }
